...
/**
 * Created by codetribe on 2/2/2018.
 */

public class DeactivatedStudents extends AppCompatActivity {
        ...
        childEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(/*"Codetribe TIH".equals(user.getFacility()) && */"Student".equals(user.getRole()) && !Objects.equals(user.getStatus(), "Able")) {
                        allUsers.add(user);
                        counter++;
